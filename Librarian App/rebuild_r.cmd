...
if "%~0"=="REBUILD_R.cmd" goto BEGIN
cls
echo RE-BUILDING PROJECTS ÄÄ "RELEASE":
...
:SUCCESS
if "%~0"=="REBUILD_R.cmd" goto FINISH
echo.
echo ÜÜÜ REBUILD PROJECTS (RELEASE) ÄÄ SUCCESS ÜÜÜ
goto FINISH

:FAILURE
if "%~0"=="REBUILD_R.cmd" goto ERROR
echo.
echo ÜÜÜ ## REBUILD PROJECTS (RELEASE) ÄÄ FAILURE ÜÜÜ
goto ERROR
...
:ERROR
if "%~0"=="REBUILD_R.cmd" goto SKIP_ERROR_PAUSE
echo 
pause
...
:FINISH
if "%~0"=="REBUILD_R.cmd" goto SKIP_FINISH_PAUSE
echo.
pause
