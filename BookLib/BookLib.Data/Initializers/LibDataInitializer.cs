...
namespace BookLib.Initializers
{
    public class LibDataInitializer
    {
        public static void Initialize(ApplicationDbContext db)
        {
            ...
            {
                db.Genre.AddRange(
                    new Genre { Name = "Детектив", IdCategory = categoryId },
                    new Genre { Name = "Триллер", IdCategory = categoryId },
                    new Genre { Name = "Комедия", IdCategory = categoryId },
                    new Genre { Name = "Драма", IdCategory = categoryId },
                    new Genre { Name = "Трагикомедия", IdCategory = categoryId },
                    new Genre { Name = "Приключения", IdCategory = categoryId },
                    new Genre { Name = "Фантастика", IdCategory = categoryId },
                    new Genre { Name = "Фэнтези", IdCategory = categoryId }
                );
                db.SaveChanges();
            }
            if (!db.Author.Any())
            ...
            foreach (Author a in db.Author)
            {
                authorId.Add(a.Id);
            }
            List<int> publisherId = new List<int>();
            foreach (Publisher a in db.Publisher)
            {
                publisherId.Add(a.Id);
            }
            //ISBN: 2 - 266 - 11156 - 6.
            ...
            if (!db.Book.Any())
            {
                ...
                //int authorId1 = db.Author.FirstOrDefault(a => a.Name == "Ю Несбе").Id;
                //int publisherId1 = db.Publisher.FirstOrDefault(a => a.Name == "Иностранка").Id;
                //int seriesId1 = db.Series.FirstOrDefault(a => a.Name == "Авторская серия Ю. Несбё").Id;
                //int genreId1 = db.Genre.FirstOrDefault(a => a.Name == "Детективы, триллеры").Id;

                //int authorId2 = db.Author.FirstOrDefault(a => a.Name == "Оливер Боуден").Id;
                //int publisherId2 = db.Publisher.FirstOrDefault(a => a.Name == "Азбука").Id;
                //int genreId2 = db.Genre.FirstOrDefault(a => a.Name == "Фантастика, фэнтези").Id;

                //int authorId3 = db.Author.FirstOrDefault(a => a.Name == "Филис Кристина Каст").Id;
                //int publisherId3 = db.Publisher.FirstOrDefault(a => a.Name == "Центрполиграф").Id;

                //int authorId4 = db.Author.FirstOrDefault(a => a.Name == "Нина Лакур").Id;
                //int publisherId4 = db.Publisher.FirstOrDefault(a => a.Name == "Popcorn Books").Id;
                //int genreId3 = db.Genre.FirstOrDefault(a => a.Name == "Романы").Id;

                //int authorId5 = db.Author.FirstOrDefault(a => a.Name == "Анна Тодд").Id;
                //int publisherId5 = db.Publisher.FirstOrDefault(a => a.Name == "Эксмо").Id;
                //db.Book.AddRange(
                //    new Book
                //    {
